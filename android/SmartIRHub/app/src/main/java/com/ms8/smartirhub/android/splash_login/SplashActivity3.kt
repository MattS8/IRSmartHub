...
//                    FirestoreActions.listenToUserData2(username)
//                }
...
////                AppState.userData.user = User(
////                    uid = FirebaseAuth.getInstance().currentUser!!.uid,
////                    username = doc.id)
////                try {
////                    AppState.userData.user.groups = ObservableArrayList<String>().apply { addAll(doc["groups"] as ArrayList<String>) }
////                } catch (e : java.lang.Exception) {
////                    Log.e("onUserFromUidSuccess", "$e")
////                    showUnknownError(e)
////                    AppState.userData.user = User()
////                }
//                AppState.userData.user = doc.toObject(User::class.java) ?: User()
//
//
//                if (AppState.userData.user.username != "")
//                    FirestoreActions.listenToUserData2(AppState.userData.user.username)
//                else
//                    showUsernameLayout(true)
//            }
//        }
